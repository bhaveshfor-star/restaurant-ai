            ...
            <div className="p-6 space-y-6 overflow-y-auto flex-1">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="number" value={form.gross_profit} onChange={e => setForm(f => ({ ...f, gross_profit: e.target.value }))} className="input-field text-sm py-2.5" placeholder="e.g. 20000" step="100" />
                    <p className="text-xs text-gray-600 mt-1">Sales - Cost of Goods</p>
                  </div>
                  <div>
                    <label className="block text-xs font-medium text-gray-400 mb-1.5">Net Profit (₹)</label>
                    <input type="number" value={form.net_profit} onChange={e => setForm(f => ({ ...f, net_profit: e.target.value }))} className="input-field text-sm py-2.5" placeholder="e.g. 12000" step="100" />
                    <p className="text-xs text-gray-600 mt-1">Gross - Operating Expenses</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-4 rounded-xl bg-blue-500/10 border border-blue-500/20">
                ...
                <div className="text-xs text-blue-200/80 space-y-0.5 font-mono">
                  <div>Sales: ₹50,000 | Orders: 150</div>
                  <div>Dine In: 80 | Online: 50 | Takeaway: 20</div>
